...
//import {simplificationLevel} from '../sidepanel.ts';

//console.log('simplificationLevel', simplificationLevel);
...
//         // If the current simplication level is null, simplify the selected text by one level
//         if (simplificationLevel === '') {
//             // Get prompt template based on the selected text's level
...
//         //if the current simplication level is null, simplify the selected text to the set level
//         else {
//             // Get prompt template based on the selected text's level
//             const promptTemplate = SIMPLIFICATION_PROMPTS[currentLevel];
//             console.log("Prompt template found:", !!promptTemplate);

//             if (!promptTemplate) {
//                 console.error("No prompt template found for level:", currentLevel);
//                 sendResponse({ error: "Invalid grade level" });
//                 return true;
//             }
...
import { generateContent } from './api.js';
import { GRADE_LEVELS, SIMPLIFICATION_PROMPTS } from './gradeConfig.js';
//import { simplificationLevel } from '../sidepanel';
